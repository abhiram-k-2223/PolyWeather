...
| 11 | ~~**账户中心缺少个人设置**~~ — 当前产品阶段不需要，用户通过钱包地址识别身份已足够 | 已决策不做 |
...
8. ~~**应用内反馈入口**~~ ✅ 已完成 — 顶栏 Telegram 反馈按钮
9. ~~**entitlement-required 页面美化**~~ ✅ 已完成 — 品牌化设计 + 导航
10. **Docs 搜索** — 简单的客户端全文搜索

### 已决策不做

- **账户设置补充** — 当前产品阶段钱包地址 + Telegram 已足够标识用户
- **通知偏好设置** — 用户量小，Telegram 群发已覆盖
